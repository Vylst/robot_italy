...
'''
Stoping at September 27th, 12:44
EPS: 0.4574024183463225
...
async def emotion(websocket, path):
	...
	eyes = keras.models.load_model('models/2021-09-21_eyes.h5')
	mouth = keras.models.load_model('models/2021-09-21_mouth.h5')
